...
<?php
    ...
    $seconds=$database->secondsToClosingTime();
        ...
        <div class="home_page container-fluid">
	        <div class="row">
	            <div class="first_row_home">
		            <div class="col-md-8">
	                <?php if($user!=null){ ?>
	                    <div class="welcome three_quarter box_home" <?php if($database->getTeam($user->getId(),$config['current_round'])->getPlayers()==null) echo "onclick=\"javascript:location.href='maketeam.php'\""; ?> >
	                        
	                        Benvenuto <?php echo $user->getUsername(); ?><br>
	                        <span class="minor">Hai totalizzato <span class="punti_highlight"><?php echo $database->getInfoRound($config['last-round'])[$user->getId()]['points']; ?></span> punti nella <?php echo $config['last-round']; ?>° Giornata<br>
