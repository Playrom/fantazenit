...
}else if($username!= null && $userAuth == 1 ){
			...
			<div class="row ">
			    <div class="col-md-12">
			        <form class="form-horizontal white-with-padding" action="editformations.php" method="post">
	                	...
	                	<div class="form-group">
		                    <h3 class="col-md-8 control-label left-label">Round&nbsp;&nbsp;</h3>
		                    
		                    <div class="col-md-4">
		                        <select class="form-control"  name="round" >
		                            <?php foreach($rounds as $this_round){ ?>
		                                <option <?php echo "value=\"".$this_round."\""; if($this_round == $round) echo " selected"; ?> ><?php echo $this_round; ?></option> 
		                            <?php }  ?>
                        		</select>
	                    	</div>
	                	</div>
...
<script>
    ...
    var getValuesEditFormation=function(){
        var jsonObj = [];
        var reserves=[];
        var jsonString;
